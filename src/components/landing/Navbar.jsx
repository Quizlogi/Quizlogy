...
export function NavbarDefault() {
  ...
  return (
    <Navbar className='fixed w-full top-0 mx-auto max-w-full px-4 py-2 border-b lg:px-8 lg:py-4'>
        ...
        <div className='flex items-center gap-x-1'>
          <Link to='/login'>
            <Button
              variant='text'
              size='sm'
              className='hidden lg:inline-block transition-all duration-300 color: text-secondary hover:text-white hover:bg-indigo-600'>
              <span>Log In</span>
            </Button>
          </Link>
          <Link to='/register'>
      ...
      <Collapse open={openNav}>
        <div className='container rounded-xl mx-auto bg-indigo-950'>
          {navList}
          <div className='flex items-center gap-x-1 ml-4'>
            <Link to='/login'>
              <Button
                ...
                variant='text'
                size='sm'
                className='transition-all duration-300 color: text-secondary hover:text-white hover:bg-indigo-600 mb-5'>
                <span>Log In</span>
              </Button>
            </Link>
            <Link to='/register'>
              <Button
                ...
                // variant="gradient"
                size='sm'
                className='bg-secondary transition-all duration-300 hover:text-white hover:bg-indigo-600 mb-5'>
                <span>Sign Up</span>
              </Button>
            </Link>
          </div>
